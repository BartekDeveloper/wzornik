export const DESCRIPTIONS: Record<string, string> = {
  ...
  "suma-ciagu-arytmetycznego": "Suma n wyrazów ciągu arytmetycznego; każdy składnik wstecz.",
  "suma-ciagu-geometrycznego": "Suma n wyrazów ciągu geometrycznego; Sₙ, a₁ i n wstecz.",
  "szereg-geometryczny": "Suma nieskończonego szeregu dla |q| < 1; S, a₁ i q wstecz.",
  "tw-sinusow": "Bok z kąta i R albo kąt z boku i R (stopnie).",
  "tw-cosinusow": "Bok z dwóch boków i kąta albo kąt z trzech boków.",
  "okrag-opisany-wpisany": "Promienie R i r z boków trójkąta (Heron w środku).",
  "schemat-bernoulliego": "Prawdopodobieństwo k sukcesów w n próbach.",
  ...
  "predkosc-chwilowa": "Prędkość po czasie t w ruchu jednostajnie zmiennym; każdy składnik wstecz.",
  "energia-wewnetrzna": "Energia wewnętrzna gazu doskonałego U = 3nRT/2.",
  "oporniki-szeregowo": "Opór zastępczy szeregowy; pojedyncze oporniki wstecz.",
