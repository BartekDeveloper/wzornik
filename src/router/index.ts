...
function titleFor(name: string | symbol | null | undefined, params: Record<string, string | string[]>): string {
  ...
  switch (name) {
    ...
    case 'wzornik':
      return subject ? `Wzornik — ${subject} | Wzornik Maturalny` : 'Wzornik — wszystkie wzory | Wzornik Maturalny'
    case 'solver':
